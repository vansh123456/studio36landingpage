...
import "./App.css";
import Canvas from "./Canvas"; // Ensure this path and capitalization match your file structure
  ...
  return (
    <>
      <div className="w-full relative min-h-screen font-[Helvetica_Now_Display] overflow-x-hidden">
        ...
        <div
          className="w-full h-screen text-white text-2xl relative z-[1]"
          data-scroll-section
        >
          <nav className="w-full px-20 py-8 flex justify-between items-center">
            ...
            <div className="links flex gap-10">
              {["Home", "About", "Projects", "Contact"].map((link) => (
                <a
                  key={link}
                  className="text-white text-md hover:opacity-50 transition-all"
